...
def send_email(workflow_name, repo_name, workflow_run_id=None):
    # Email details
    ...
    body = f"Hi, the workflow '{workflow_name}' has failed for the repo {repo_name}. Please check the logs for more details.\nMore Details: \nRun_ID: {workflow_run_id}"
